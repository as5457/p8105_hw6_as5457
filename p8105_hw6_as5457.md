...
```
    ...
    ## # A tibble: 47 x 7
    ##    city_state   term         log_OR    OR lower_bound upper_bound  p.value
    ##    <chr>        <chr>         <dbl> <dbl>       <dbl>       <dbl>    <dbl>
    ##  1 Albuquerque~ victim_rac~ -0.324  0.723      0.438        1.19   2.06e-1
    ##  2 Atlanta, GA  victim_rac~ -0.284  0.753      0.432        1.31   3.17e-1
    ##  3 Baltimore, ~ victim_rac~ -0.820  0.441      0.313        0.620  2.68e-6
    ##  4 Baton Rouge~ victim_rac~ -0.404  0.668      0.313        1.43   2.96e-1
    ##  5 Birmingham,~ victim_rac~  0.0385 1.04       0.615        1.76   8.86e-1
    ##  6 Boston, MA   victim_rac~ -2.15   0.116      0.0480       0.282  1.96e-6
    ##  7 Buffalo, NY  victim_rac~ -0.936  0.392      0.214        0.719  2.47e-3
    ##  8 Charlotte, ~ victim_rac~ -0.584  0.558      0.321        0.969  3.83e-2
    ##  9 Chicago, IL  victim_rac~ -0.576  0.562      0.431        0.733  2.07e-5
    ## 10 Cincinnati,~ victim_rac~ -1.14   0.318      0.184        0.551  4.28e-5
    ## # ... with 37 more rows

...
![](p8105_hw6_as5457_files/figure-markdown_github/unnamed-chunk-12-1.png)
...
cross_result = cross_valid %>%  #model 1 is my model
  ...
  mutate(model1_rmse = map2_dbl(model1, test, ~rmse(model = .x, data = .y)),
         model2_rmse = map2_dbl(model2, test, ~rmse(model = .x, data = .y)),
         model3_rmse = map2_dbl(model3, test, ~rmse(model = .x, data = .y)))
```
